	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="span12">
				...
				<h3><?php echo $wp_query->found_posts; ?> resultados encontrados para "<span><?php the_search_query(); ?></span>"</h3>
					...
					<?php if (have_posts()) : ?>
						...
						<?php previous_posts_link('Anteriores') ?> <?php next_posts_link('Próximos','') ?>
